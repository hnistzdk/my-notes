...
![1553261992653](http://zdk-blog-image.test.upcdn.net//images/202203011854138.png) 

查询速度很快， 接近0s ， 主要的原因是因为id为主键， 有索引；

![1553262044466](http://zdk-blog-image.test.upcdn.net//images/202203011854407.png) 
...
![1553262215900](http://zdk-blog-image.test.upcdn.net//images/202203011854273.png) 

查看SQL语句的执行计划 ： 

![1553262469785](http://zdk-blog-image.test.upcdn.net//images/202203011854941.png) 
...
![1553263229523](http://zdk-blog-image.test.upcdn.net//images/202203011854682.png) 



索引创建完成之后，再次进行查询 ： 

![1553263302706](http://zdk-blog-image.test.upcdn.net//images/202203011854065.png) 

通过 explain ， 查看执行计划，执行SQL时使用了刚才创建的索引 

![1553263355262](http://zdk-blog-image.test.upcdn.net//images/202203011854912.png) 
...
![1556170997921](http://zdk-blog-image.test.upcdn.net//images/202203011854436.png) 
...
![1556171348995](http://zdk-blog-image.test.upcdn.net//images/202203011854915.png)  



`违法最左前缀法则 ， 索引失效：这里是查询索引的第二个字段，导致失效。查第三个字段也会失效`

![1556171428140](http://zdk-blog-image.test.upcdn.net//images/202203011854161.png) 



`如果符合最左法则，但是出现跳跃某一列，只有最左列索引生效：`

![1556171662203](http://zdk-blog-image.test.upcdn.net//images/202203011854183.png) 
...
![1556172256791](http://zdk-blog-image.test.upcdn.net//images/202203011854720.png) 



### 4).不要在where中对索引列进行运算操作或函数操作，否则索引将失效。

![1556172813715](http://zdk-blog-image.test.upcdn.net//images/202203011854038.png) 

### 5).当数据类型出现隐式转换时，比如 varchar 不加单引号可能转换为 int 类型时，会使索引无效，触发全表扫描

![1556172967493](http://zdk-blog-image.test.upcdn.net//images/202203011854561.png) 
...
![1556173928299](http://zdk-blog-image.test.upcdn.net//images/202203011854876.png) 

如果查询列，超出索引列，也会降低性能。

![1556173986068](http://zdk-blog-image.test.upcdn.net//images/202203011854965.png) 
...
![1556174994440](http://zdk-blog-image.test.upcdn.net//images/202203011854794.png) 
...
![1556175114369](http://zdk-blog-image.test.upcdn.net//images/202203011854604.png) 
...
![1556247686483](http://zdk-blog-image.test.upcdn.net//images/202203011854752.png) 
...
![1556175445210](http://zdk-blog-image.test.upcdn.net//images/202203011854874.png) 
...
![1556180634889](http://zdk-blog-image.test.upcdn.net//images/202203011854981.png)  

### 11).in走索引，not in 索引失效。

在mysql 5.6中

![1556249602732](http://zdk-blog-image.test.upcdn.net//images/202203011854131.png)  
...
![image-20210523131109106](http://zdk-blog-image.test.upcdn.net//images/202203011854655.png)
...
>
> ![image-20220306211804264](http://zdk-blog-image.test.upcdn.net//images/202203062118329.png)
...
![1552885364563](http://zdk-blog-image.test.upcdn.net//images/202203011854595.png)
