...
![image-20220308160104448](https://gitee.com/hnistzdk/picture/raw/master/images/202203081601515.png)
...
>
>    ![image-20220308162417059](https://gitee.com/hnistzdk/picture/raw/master/images/202203081624247.png)
>
...
![image-20220316205645963](https://gitee.com/hnistzdk/picture/raw/master/images/image-20220316205645963.png)

![image-20220316205727401](https://gitee.com/hnistzdk/picture/raw/master/images/image-20220316205727401.png)
...
>
> ![image-20220322193057064](https://gitee.com/hnistzdk/picture/raw/master/images/202203221930174.png)
>
> 
>
> 因为
...
class Solution {
    ...
    public TreeNode build(int[] preorder,int preStart,int preEnd,int[] inorder,int inStart,int inEnd){
        ...
        //找到中序数组里的root结点索引,它左边就是左子树的所有数字,右边是右子树的
        int boundIndex = indexMap.get(rootVal);
        //左子树结点数量
        int leftSize = boundIndex - inStart;
        TreeNode root = new TreeNode(rootVal);
        root.left = build(preorder,preStart+1,leftSize+preStart,inorder,inStart,boundIndex-1);
        root.right = build(preorder,leftSize+preStart+1,preEnd,inorder,boundIndex+1,inEnd);
        return root;
    }
}
```
