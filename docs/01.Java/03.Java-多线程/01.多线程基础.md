...
- JVM内存结构
  ...
  ![image-20211101132448652](http://zdk-blog-image.test.upcdn.net//images/image-20211101132448652.png)
...
- 调度策略：
  - 时间片![image-20211101132527618](http://zdk-blog-image.test.upcdn.net//images/image-20211101132527618.png)
  - **抢占式：高优先级的线程会抢占CPU**
- java的调度方式
...
![image-20211101132541369](http://zdk-blog-image.test.upcdn.net//images/image-20211101132541369.png)

![image-20211101210652747](http://zdk-blog-image.test.upcdn.net//images/image-20211101210652747.png)
...
![image-20211106162901458](http://zdk-blog-image.test.upcdn.net//images/image-20211106162901458.png)
