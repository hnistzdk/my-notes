...
![1556269346488](http://zdk-blog-image.test.upcdn.net//images/202203011854248.png) 
...
![1555771750567](http://zdk-blog-image.test.upcdn.net//images/202203011854086.png)
...
![1555772132736](http://zdk-blog-image.test.upcdn.net//images/202203011855499.png) 
...
![1555772351208](http://zdk-blog-image.test.upcdn.net//images/202203011855023.png)
...
![image](http://zdk-blog-image.test.upcdn.net//images/202203011855233.png)

然后可以发现这个模块已经启用了：

![image](http://zdk-blog-image.test.upcdn.net//images/202203011855602.png)
...
![1556335817763](http://zdk-blog-image.test.upcdn.net//images/202203011855561.png) 

2). 第二种通过有序索引顺序扫描直接返回有序数据，这种情况即为 using index，不需要额外排序，操作效率高。

![1556335866539](http://zdk-blog-image.test.upcdn.net//images/202203011855676.png) 

多字段排序

![1556336352061](http://zdk-blog-image.test.upcdn.net//images/202203011855242.png) 
...
![1556338367593](http://zdk-blog-image.test.upcdn.net//images/202203011855261.png) 
...
![1556339573979](http://zdk-blog-image.test.upcdn.net//images/202203011855599.png)  
...
![1556339633161](http://zdk-blog-image.test.upcdn.net//images/202203011855120.png)  
...
![1556339688158](http://zdk-blog-image.test.upcdn.net//images/202203011855071.png) 



**但是在 mysql 5.7 中：**

![image-20210523150730770](http://zdk-blog-image.test.upcdn.net//images/202203011855178.png)
...
![1556359399199](http://zdk-blog-image.test.upcdn.net//images/202203011855243.png)   
...
![1556359482142](http://zdk-blog-image.test.upcdn.net//images/202203011855877.png)   

连接(Join)查询之所以更有效率一些 ，是因为MySQL不需要在内存中创建临时表来完成这个逻辑上需要两个步骤的查询工作。

在 mysql 5.7 中

![image-20210523151026166](http://zdk-blog-image.test.upcdn.net//images/202203011855303.png)
...
![1556354464657](http://zdk-blog-image.test.upcdn.net//images/202203011855325.png)  
...
![1556354887509](http://zdk-blog-image.test.upcdn.net//images/202203011855015.png)

![1556354920964](https://cdn.jsdelivr.net/gh/oddfar/static/img/MySQL高级.assets/1556354920964.png)  

建议使用 union 替换 or ： 

![1556355027728](http://zdk-blog-image.test.upcdn.net//images/202203011855515.png) 
...
![1556361314783](http://zdk-blog-image.test.upcdn.net//images/202203011855752.png) 

**优化思路一**

在索引上完成排序分页操作，最后根据主键关联回原表查询所需要的其他列内容。

![1556416102800](http://zdk-blog-image.test.upcdn.net//images/202203011855151.png) 
...
![1556363928151](http://zdk-blog-image.test.upcdn.net//images/202203011855999.png) 
...
![1556370971576](http://zdk-blog-image.test.upcdn.net//images/202203011855311.png) 
...
![1556371004594](http://zdk-blog-image.test.upcdn.net//images/202203011855981.png) 
...
![1556371355788](http://zdk-blog-image.test.upcdn.net//images/202203011855858.png) 
