...
![image-20211101133155477](http://zdk-blog-image.test.upcdn.net//images/image-20211101133155477.png)	
...
1. 简介
   ...
   ![image-20211101133201992](http://zdk-blog-image.test.upcdn.net//images/image-20211101133201992.png)
   ...
   2. 常用命令
      ...
      - setbit[key] [offset] [value] 设bitmaps中某个偏移量的值为0或1.offset：偏移量从0开始
        ...
        ![image-20211101133208197](http://zdk-blog-image.test.upcdn.net//images/image-20211101133208197.png)
   ...
   3. set与bitmap对比
      ...
      ![image-20211101133218544](http://zdk-blog-image.test.upcdn.net//images/image-20211101133218544.png)	![image-20211101133225425](http://zdk-blog-image.test.upcdn.net//images/image-20211101133225425.png)	![image-20211101133231200](http://zdk-blog-image.test.upcdn.net//images/image-20211101133231200.png)	
...
1. 简介
   ...
   ![image-20211101133250834](http://zdk-blog-image.test.upcdn.net//images/image-20211101133250834.png)	![image-20211101133304014](http://zdk-blog-image.test.upcdn.net//images/image-20211101133304014.png)	
   
   ![image-20211101133311498](http://zdk-blog-image.test.upcdn.net//images/image-20211101133311498.png)	
...
1. 简介
   ...
   ![image-20211101133318417](http://zdk-blog-image.test.upcdn.net//images/image-20211101133318417.png)	
...
- 使用jedis连接时，也需要加上密码
  ...
  ![image-20211101133324485](http://zdk-blog-image.test.upcdn.net//images/image-20211101133324485.png)
...
- 开启事务：multi
  ...
  ![image-20211101133330639](http://zdk-blog-image.test.upcdn.net//images/image-20211101133330639.png)

- 命令入队：输入一系列命令

  ![image-20211101133335437](http://zdk-blog-image.test.upcdn.net//images/image-20211101133335437.png)

- 中途也可取消事务：使用discard命令

  ![image-20211101133339820](http://zdk-blog-image.test.upcdn.net//images/image-20211101133339820.png)

- 执行事务：exec

  ![image-20211101133346972](http://zdk-blog-image.test.upcdn.net//images/image-20211101133346972.png)
...
![image-20211101133427852](http://zdk-blog-image.test.upcdn.net//images/image-20211101133427852.png)	因为队列中有一次命令出现了语法错误，所以所有命令均未执行



> 出现运行时异常(如1/0这种)，出现此种错误，其他命令仍可正常执行

![image-20211101133435210](http://zdk-blog-image.test.upcdn.net//images/image-20211101133435210.png)
...
- 使用watch[key]....：监控一个或多个key，当事务未执行时，如果监控的key的值发生了改变，事务便不会执行
  ...
  - 先设定两个初值k1 k2，监控k1，然后进行事务
    ...
    ![image-20211101133447825](http://zdk-blog-image.test.upcdn.net//images/image-20211101133447825.png)

  - 在事务未执行时，在另一终端标签页对k1 k2进行修改

    ![image-20211101133453321](http://zdk-blog-image.test.upcdn.net//images/image-20211101133453321.png)	

  - 再回到原来的页面执行事务，发现事务并没有执行，使用unwatch后继续监控key

    ![image-20211101133459234](http://zdk-blog-image.test.upcdn.net//images/image-20211101133459234.png)
...
1. RDB(Redis DataBase)
   ...
   ![image-20211101133513460](http://zdk-blog-image.test.upcdn.net//images/image-20211101133513460.png)	
...
2. AOF(Append Only File)
   ...
   ![image-20211101133519677](http://zdk-blog-image.test.upcdn.net//images/image-20211101133519677.png)	
...
1. 打开一个客户端订阅一个频道为channel1
   ...
   ![image-20211101133528305](http://zdk-blog-image.test.upcdn.net//images/image-20211101133528305.png)	
...
2. 打开另一个客户端，给channel1发布消息hello
   ...
   ![image-20211101133533705](http://zdk-blog-image.test.upcdn.net//images/image-20211101133533705.png)	

   发布成功返回的是订阅者的数量

3. 订阅了channel1的订阅者收到消息

   ![image-20211101133538886](http://zdk-blog-image.test.upcdn.net//images/image-20211101133538886.png)	
