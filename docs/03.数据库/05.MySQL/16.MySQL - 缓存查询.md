...
开启Mysql的查询缓存，当执行完全相同的SQL语句的时候，服务器就会直接从缓存中读取结果，当数据被修改，之前的缓存会失效，修改比较频繁的表不适合做查询缓存。
 ...
 ![20180919131632347](http://zdk-blog-image.test.upcdn.net//images/202203011855172.png) 
...
![1555249929012](http://zdk-blog-image.test.upcdn.net//images/202203011855066.png)
...
![1555250015377](http://zdk-blog-image.test.upcdn.net//images/202203011855861.png)
...
![1555250142451](http://zdk-blog-image.test.upcdn.net//images/202203011855159.png)  	
...
![1555250443958](http://zdk-blog-image.test.upcdn.net//images/202203011855649.png) 
