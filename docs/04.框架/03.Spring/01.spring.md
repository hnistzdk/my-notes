...
- **@Value注解的使用**(放到属性上和set方法上是一样的)
  ![img_1.png](https://gitee.com/hnistzdk/picture/raw/master/images/202201051020087.png)
...
- **使用纯Java形式完成bean.xml配置文件的操作**
  ...
  ![img_2.png](https://gitee.com/hnistzdk/picture/raw/master/images/202201051020223.png)![img_3.png](https://gitee.com/hnistzdk/picture/raw/master/images/202201051020440.png)![img_4.png](https://gitee.com/hnistzdk/picture/raw/master/images/202201051020494.png)
...
2. 表示切面执行的位置，使用execution切入表达式
   ...
   ![image-20211129202808721](https://gitee.com/hnistzdk/picture/raw/master/images/202201051021564.png)

   ![image-20211129203112456](https://gitee.com/hnistzdk/picture/raw/master/images/image-20211129203112456.png)
   ...
   >
   > ![image-20211129203915773](https://gitee.com/hnistzdk/picture/raw/master/images/image-20211129203915773.png)
...
- `PROPAGATION_REQUIRED`
  ...
  >
  > ![image-20211209194055910](https://gitee.com/hnistzdk/picture/raw/master/images/image-20211209194055910.png)
...
- `PROPAGATION_REQUIRES_NEW`
  ...
  >
  > ![image-20211209194622683](https://gitee.com/hnistzdk/picture/raw/master/images/image-20211209194622683.png)

- `PROPAGATION_SUPPORTS`

  > 指定的方法支持当前事务，但若当前没有事务，也可以以非事务方式执行(查询操作)
  >
  > ![image-20211209194328413](https://gitee.com/hnistzdk/picture/raw/master/images/image-20211209194328413.png)
