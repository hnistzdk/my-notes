...
>
>![image-20211103212458023](http://zdk-blog-image.test.upcdn.net//images/image-20211103212458023.png)
...
5. 枚举类实现避免反射获取(枚举类天然就是线程安全和单例的)
   ...
   > ![image-20211114123138025](http://zdk-blog-image.test.upcdn.net//images/202201061600198.png)
   >
