...
- 即www.xxx.com/请求/请求/请求  而不是?参数形式
  ![img.png](http://zdk-blog-image.test.upcdn.net//images/202201051019464.png)
  
- restful在springMVC中的用法
  ![img_1.png](http://zdk-blog-image.test.upcdn.net//images/202201051019015.png)
- 好处
![img_2.png](http://zdk-blog-image.test.upcdn.net//images/202201051019712.png)
- 代码示例
```java
@Controller
...
### 4.2 通过springMVC来实现
  ![img_3.png](http://zdk-blog-image.test.upcdn.net//images/202201051020511.png)
...
```
![img_4.png](http://zdk-blog-image.test.upcdn.net//images/202201051020034.png)
