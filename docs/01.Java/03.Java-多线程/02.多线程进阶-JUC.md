...
![image-20211107174811798](http://zdk-blog-image.test.upcdn.net//images/image-20211107174811798.png)
...
![image-20211107172603900](http://zdk-blog-image.test.upcdn.net//images/202201061137742.png)
...
![image-20211107172836649](http://zdk-blog-image.test.upcdn.net//images/image-20211107172836649.png)
...
>
>![image-20211107190557984](http://zdk-blog-image.test.upcdn.net//images/202201061137701.png)
>
...
>
>![image-20211107190752154](http://zdk-blog-image.test.upcdn.net//images/image-20211107190752154.png)
>
>```java
>class Number {
>private Integer number = 0;
...
![image-20211108140443118](http://zdk-blog-image.test.upcdn.net//images/image-20211108140443118.png)
...
2. Collections
   ...
   >
   >![image-20211108140718552](http://zdk-blog-image.test.upcdn.net//images/image-20211108140718552.png)
   >
   >不过此方法也比较古老，很少使用
...
>
>![image-20211108160207178](http://zdk-blog-image.test.upcdn.net//images/202201061137951.png)
>
>因为后面只有1个线程未执行了，而cyclicBarrier.await()仍然需要等到有7个线程执行完。
>
>阅读源码发现，CyclicBarrier内部执行await()时调用dowait()方法，仍是减操作
>
>![image-20211108160621965](http://zdk-blog-image.test.upcdn.net//images/image-20211108160621965.png)
...
3. 代码示例
   ...
   ![image-20211108162741451](http://zdk-blog-image.test.upcdn.net//images/image-20211108162741451.png)
...
![image-20211110175800442](http://zdk-blog-image.test.upcdn.net//images/202201061137957.png)
...
1. 抛异常
   ...
   >
   >![image-20211110181503075](http://zdk-blog-image.test.upcdn.net//images/image-20211110181503075.png)
...
2. 谁调用找谁
   ...
   >
   >![image-20211110181419697](http://zdk-blog-image.test.upcdn.net//images/202201061137096.png)
...
![image-20211110175146651](http://zdk-blog-image.test.upcdn.net//images/202201061137106.png)
...
>
> ![image-20211111201623717](http://zdk-blog-image.test.upcdn.net//images/202201061137074.png)
...
![image-20211113182321944](http://zdk-blog-image.test.upcdn.net//images/202201061137988.png)
