...
![image-20210520161848827](http://zdk-blog-image.test.upcdn.net//images/202203011850591.png)

真正执行的顺序：

​		随着 Mysql 版本的更新换代，其优化器也在不断的升级，优化器会分析不同执行顺序产生的性能消耗不同而动 态调整执行顺序。下面是经常出现的查询顺序：

![image-20210520161931864](http://zdk-blog-image.test.upcdn.net//images/202203011850785.png)

![image-20210520164022838](http://zdk-blog-image.test.upcdn.net//images/202203011850277.png)
...
![1551186043529](http://zdk-blog-image.test.upcdn.net//images/202203011850937.png)
...
![1556086372754](http://zdk-blog-image.test.upcdn.net//images/202203011850293.png)
...
- 事务控制
  ...
  **
  ...
  ![1556075130115](http://zdk-blog-image.test.upcdn.net//images/202203011850447.png)
...
- 外键约束
  ...
  ![1556087540767](http://zdk-blog-image.test.upcdn.net//images/202203011850489.png)
  ...
  ![1556087611295](http://zdk-blog-image.test.upcdn.net//images/202203011851671.png)

  删除 country_id为 1 的 country 数据，有外键时会删除失败

  ![1556087719145](http://zdk-blog-image.test.upcdn.net//images/202203011851950.png)
  ...
  ![1556087759615](http://zdk-blog-image.test.upcdn.net//images/202203011851952.png)

  更新后， 子表的数据信息为 ：

  ![1556087793738](http://zdk-blog-image.test.upcdn.net//images/202203011851964.png)
...
- **存储方式**	
  ...
  ![1556075336630](http://zdk-blog-image.test.upcdn.net//images/202203011851455.png)
...
- 不支持事务
  ...
  ![1551347590309](http://zdk-blog-image.test.upcdn.net//images/202203011851898.png)
...
- 文件存储方式
  ...
  ![1556075073836](http://zdk-blog-image.test.upcdn.net//images/202203011851997.png)
...
![1556076359503](http://zdk-blog-image.test.upcdn.net//images/202203011851320.png)
...
![1551408083254](http://zdk-blog-image.test.upcdn.net//images/202203011851154.png)

order_1991中的数据 ： 

![1551408133323](http://zdk-blog-image.test.upcdn.net//images/202203011851574.png)

order_all中的数据 ：

![1551408216185](http://zdk-blog-image.test.upcdn.net//images/202203011851366.png)
...
![1551408519889](http://zdk-blog-image.test.upcdn.net//images/202203011851112.png)
...
![image-20210520162731111](http://zdk-blog-image.test.upcdn.net//images/202203011851593.png)
