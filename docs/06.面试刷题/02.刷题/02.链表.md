...
>
> ![在这里插入图片描述](http://zdk-blog-image.test.upcdn.net//images/202202281543321.png)
...
![image-20220305191129288](http://zdk-blog-image.test.upcdn.net//images/202203051911340.png)
...
>
> ![image-20220306142505252](http://zdk-blog-image.test.upcdn.net//images/202203061425337.png)
...
>
> ![img](http://zdk-blog-image.test.upcdn.net//images/202203061510645.jpg)
...
>
> 当l1和l2都不为空时，比较l1和l2的val的大小，把较小的接到dummy的后面，然后就将较小的这条链表的指针往后移动一哥，直到l1或l2有一个为空。
>
