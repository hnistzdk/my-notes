...
export default {
  ...
  methods: {
    init() {
      ...
      screenMask.src = "/img/fantasy/Screenmask.png";

      var screen = new Image();
      screen.src = "/img/fantasy/screen.png";
      ...
      // 加载图片
      var bg = new Image();
      bg.src = "/img/fantasy/bg.png";

      var mask = new Image();
      mask.src = "/img/fantasy/mask.png";

      var light = new Image();
      light.src = "/img/fantasy/light.png";

      var caidai = new Image();
      caidai.src = "/img/fantasy/caidai.png";

      var two = new Image();
      two.src = "/img/fantasy/22.png";

      var screenLight = new Image();
      screenLight.src = "/img/fantasy/screenLight.png";

      var phoneLight = new Image();
      phoneLight.src = "/img/fantasy/phoneLight.png";
